...
def simulate_hthp(fluid_cycle1, fluid_cycle2, T_evap_c2_override=None,
    ...
    try:
        ...
        # Source water inlet (11) -> system fuel (free reservoir, c = 0);
        # outlet (12) -> system loss. Splitting them keeps the boundary
        # definition continuous across T_src = Tamb. (exerpy: inputs add,
        # outputs subtract.)
